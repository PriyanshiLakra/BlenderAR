...
setHTMLElemAttribute('className', 'warning_could_not_enter_AR', 'warning_could_not_enter_AR', false);
...
setHTMLElemAttribute('href', 'https://princy.com', 'info_button', false);
...
volume(loadMedia_WebAudio('sounds/haiyaa.mp3'), 0.5);

operateAnimation('PLAY', 'princy_armature', 0, 80, 'LoopRepeat', 1,
        function() {}, false);

    registerOnClick('princy_mesh', false, false, [0,1,2], function() {

  operateAnimation('STOP', 'princy_armature', null, null, 'AUTO', 1,
          function() {}, false);

      playSound(loadMedia_WebAudio('sounds/haiyaa.mp3'), false);

  operateAnimation('PLAY', 'princy_armature', 81, 136, 'LoopOnce', 1,
          function() {
...
checkARMode(function() {
  eventHTMLElem('pointerup', 'Enter_AR_Button', false, function(event) {
    enterARMode('ORIGIN', true, function() {
      changeVis(['GROUP', 'Princy_group'], false);
      ...
      changeVis(['GROUP', 'Princy_group'], true);
      changeVis('prompt_move_around', false);
      setObjTransform('princy_armature', false, 'position', createVector(0, 0, 0), false);
      ...
      setObjTransform('princy_armature', false, 'scale', [1, 1, 1], false);
  ...
  setHTMLElemAttribute('href', exportToUSDZ('princy_mesh'), 'Enter_AR_Button', false);
  setHTMLElemAttribute('rel', 'ar', 'Enter_AR_Button', false);
  setHTMLElemAttribute('download', 'pincy.usdz', 'Enter_AR_Button', false);
}, function() {
  eventHTMLElem('pointerup', 'Enter_AR_Button', false, function(event) {
...
registerOnClick('indicator_invis_plane', false, false, [0,1,2], function() {
  changeVis(['GROUP', 'Princy_group'], true);
  setObjTransform('princy_armature', false, 'position', [arHitPoint('x'), arHitPoint('y'), arHitPoint('z')], false);
  setObjDirection('princy_armature', getObjTransform('Camera', false, 'position', 'xyz'), true, true);
...
registerOnDrag('drag_move', false, [0,1,2], function() {}, function() {
  dragMoveAdv('princy_armature', 'XY', 'WORLD', 'zzrsUGZzp|xJ$vG.6p}f', '.a4}U@UVoecem{l[9T]N');
}, function() {}, '.a4}U@UVoecem{l[9T]N');

registerOnDrag('drag_rotate', false, [0,1,2], function() {}, function() {
  dragRotateAdv('princy_armature', 'Z', 'WORLD', 'I{hWJw[7)3T[rfLp0Jr2', 'EVII?}ATF=Q$x|G.`S6l');
}, function() {}, 'EVII?}ATF=Q$x|G.`S6l');

registerOnDrag('drag_scale', false, [0,1,2], function() {}, function() {
  dragScale('princy_armature', 'Z', '/ym=1L8eEW4VQ_8U1KLX', 'DPbu;VWs*}^$q2mseuCX');
  dragScale('princy_armature', 'Y', 'jB_:MEjC+@kuOxo1{*c_', 'DPbu;VWs*}^$q2mseuCX');
  dragScale('princy_armature', 'X', '_//Y_.m1Y2zaWOs#IM$@', 'DPbu;VWs*}^$q2mseuCX');
}, function() {}, 'DPbu;VWs*}^$q2mseuCX');

updateTextObj('scale_percentage', String(Math.round(toFixedPoint(getObjTransform('princy_armature', false, 'scale', 'z'), 2) * 100)) + '%');
